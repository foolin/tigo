...
func NewHtmlRender(config HtmlRenderConfig) tigo.Render {
	return &HtmlRender{
...
func (r *HtmlRender) RenderFile(out io.Writer, name string, data interface{}) error {
	return r.Render(out, name, data)
}
